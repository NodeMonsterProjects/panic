...
import { AggregationCursor, Collection, DbOptions } from "mongodb";
      ...
      getBlockNumber: () => {
        return new Promise((resolve, reject) => {
          web3EthGetBlockNumberPromiseResolve !== null
            ? resolve(web3EthGetBlockNumberPromiseResolve)
            : reject({ message: "test" });
        });
      },
    },
      ...
      create: (_content) => {
        return new Promise((resolve, reject) => {
          twilioClientCallsCreateResolve !== null
            ? resolve(twilioClientCallsCreateResolve)
            : reject({ message: "test" });
        });
      },
    },
...
describe("Mongo Monitorables Info POST Route", () => {
  ...
  it(
    "Should return error and status code 536 if mongo returns an " + "error",
    async () => {
...
describe("Mongo Alerts POST Route", () => {
  ...
  it.each([
    [
      ...
      {
        error:
          "Error: Missing key(s) chains, severities, sources, " +
          "minTimestamp, maxTimestamp, noOfAlerts in body.",
      },
    ],
    [
      532,
      "chains not specified",
      {
        severities: [],
        sources: [],
        minTimestamp: 0,
    ...
    [
      539,
      "invalid chain specified (non-string)",
      {
        chains: ["test_chain", 123],
        severities: [],
        sources: [],
        minTimestamp: 0,
        maxTimestamp: 0,
    ...
    [
      539,
      "invalid severity specified (non-string)",
      {
        chains: [],
        severities: ["test_chain", 123],
        sources: [],
        minTimestamp: 0,
        maxTimestamp: 0,
        noOfAlerts: 1,
      ...
      {
        error: "Error: An invalid value was given to " + "req.body.severities.",
      },
    ],
    [
      539,
      "invalid source specified (non-string)",
      {
        chains: [],
        severities: [],
        sources: ["test_chain", 123],
        minTimestamp: 0,
        maxTimestamp: 0,
        noOfAlerts: 1,
      },
    ...
    [
      539,
      "invalid severity specified (non-existing)",
      {
        chains: [],
        severities: ["TEST"],
        sources: [],
    ...
    [
      539,
      "invalid minTimestamp specified (string)",
      {
        chains: [],
        severities: [],
        sources: [],
      ...
      {
        error:
          "Error: An invalid value was given to " + "req.body.minTimestamp.",
      },
    ],
    [
      539,
      "invalid maxTimestamp specified (string)",
      {
        chains: [],
        severities: [],
        sources: [],
      ...
      {
        error:
          "Error: An invalid value was given to " + "req.body.maxTimestamp.",
      },
    ],
    [
      539,
      "invalid noOfAlerts specified (string)",
      {
        chains: [],
        severities: [],
        sources: [],
      ...
      {
        error: "Error: An invalid value was given to " + "req.body.noOfAlerts.",
      },
    ],
    [
      539,
      "invalid minTimestamp specified (negative number)",
      {
        chains: [],
        severities: [],
        sources: [],
    ...
    [
      539,
      "invalid maxTimestamp specified (negative number)",
      {
        chains: [],
        severities: [],
        sources: [],
    ...
    [
      539,
      "invalid noOfAlerts specified (negative number)",
      {
        chains: [],
        severities: [],
        sources: [],
    ...
    [
      539,
      "invalid noOfAlerts specified (zero)",
      {
        chains: [],
        severities: [],
        sources: [],
...
describe("Mongo Metrics POST Route", () => {
  ...
  it.each([
    [
      ...
      {
        error:
          "Error: Missing key(s) chains, systems, minTimestamp, " +
    ...
    [
      539,
      "invalid system specified (non-string)",
      {
        chains: [],
        systems: ["test_chain", 123],
        minTimestamp: 0,
        maxTimestamp: 0,
        noOfMetricsPerSource: 1,
      },
    ...
    [
      539,
      "invalid noOfMetricsPerSource specified (string)",
      {
        chains: [],
        systems: [],
        minTimestamp: 0,
      ...
      {
        error:
          "Error: An invalid value was given to " +
    ...
    [
      539,
      "invalid noOfMetricsPerSource specified (negative number)",
      {
        chains: [],
        systems: [],
        minTimestamp: 0,
    ...
    [
      539,
      "invalid noOfMetricsPerSource specified (zero)",
      {
        chains: [],
        systems: [],
        minTimestamp: 0,
...
describe("Redis Alerts Overview POST Route", () => {
  ...
  it.each([
    ...
    [
      538,
      "include_chain_sourced_alerts property not specified",
      {
        parentIds: {
          systems: ["test_system"],
          nodes: ["test_node"],
    ...
    [
      538,
      "invalid properties are specified",
  ...
  it(
    "Should return error and status code 534 if redis returns " + "an error",
    async () => {
  ...
  it.each([
    ...
    async (_: string, invalidValue: string, invalidValueError: string) => {
...
describe("Redis Metrics POST Route", () => {
  ...
  it.each([
    ...
    "Should return correct result and a successful status code if %s",
    async (_: string, body: any, redisRet: string[], endpointRet: any) => {
...
describe("Ping Common Service - Node Exporter POST Route", () => {
  ...
  it("Should return correct result and a successful status code if node exporter does not return an error", async () => {
  ...
  it("Should return ping error and status code 400 if node exporter returns an error", async () => {
  ...
  it("Should return ping timeout and status code 408 if node exporter returns a time out error", async () => {
...
describe("Ping Common Service - Prometheus POST Route", () => {
  ...
  it.each([
    ...
    [
      532,
      "baseChain not specified",
      { url: "test" },
      { error: "Error: Missing key(s) baseChain in body." },
    ],
    [
      532,
      "url and baseChain not specified",
      {},
  ...
  it.each([["cosmos"], ["chainlink"], ["test chain"]])(
    ...
    async (baseChain: string) => {
      const resp: AxiosResponse = emptyAxiosResponse(
        getPrometheusMetricFromBaseChain(baseChain)
      );
      axiosMock.get.mockResolvedValue(resp);
      const res = await request(app).post(endpoint).send({
        url: "test_url.com",
  ...
  it("Should return ping error and status code 400 if prometheus returns an error", async () => {
    axiosMock.get.mockResolvedValue(emptyAxiosResponse());
    const res = await request(app)
      .post(endpoint)
      .send({ url: "test_url.com", baseChain: "cosmos" });
    expect(res.statusCode).toEqual(400);
    expect(res.body).toEqual({ result: PingStatus.ERROR });
  });

  it("Should return ping timeout and status code 408 if prometheus returns a time out error", async () => {
    axiosMock.get.mockRejectedValue({ code: "ECONNABORTED" });
    const res = await request(app)
      .post(endpoint)
      .send({ url: "test_url.com", baseChain: "cosmos" });
...
describe("Ping Cosmos Service - Cosmos REST POST Route", () => {
  ...
  it("Should return correct result and a successful status code if cosmos rest does not return an error", async () => {
  ...
  it("Should return ping error and status code 400 if cosmos rest returns an error", async () => {
    axiosMock.get.mockResolvedValue(emptyAxiosResponse());
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(400);
    expect(res.body).toEqual({ result: PingStatus.ERROR });
  ...
  it("Should return ping timeout and status code 408 if cosmos rest returns a time out error", async () => {
    axiosMock.get.mockRejectedValue({ code: "ECONNABORTED" });
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(408);
    expect(res.body).toEqual({ result: PingStatus.TIMEOUT });
...
describe("Ping Cosmos Service - Tendermint RPC POST Route", () => {
  ...
  it("Should return correct result and a successful status code if tendermint rpc does not return an error", async () => {
  ...
  it("Should return ping error and status code 400 if tendermint rpc returns an error", async () => {
    axiosMock.get.mockResolvedValue(emptyAxiosResponse());
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(400);
    expect(res.body).toEqual({ result: PingStatus.ERROR });
  ...
  it("Should return ping timeout and status code 408 if tendermint rpc returns a time out error", async () => {
    axiosMock.get.mockRejectedValue({ code: "ECONNABORTED" });
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(408);
    expect(res.body).toEqual({ result: PingStatus.TIMEOUT });
...
describe("Ping Substrate Service - Websocket POST Route", () => {
  ...
  it("Should return error if Substrate env variables are not available", async () => {
  ...
  it("Should return correct result and a successful status code if request does not return an error", async () => {
    axiosMock.get.mockResolvedValue(emptyAxiosResponse());
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(200);
    expect(res.body).toEqual({ result: PingStatus.SUCCESS });
  ...
  it("Should return ping error and status code 400 if request returns an error", async () => {
  ...
  it("Should return ping timeout and status code 408 if request times out", async () => {
    axiosMock.get.mockRejectedValue({ code: "ECONNABORTED" });
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(408);
    expect(res.body).toEqual({ result: PingStatus.TIMEOUT });
...
describe("Ping Ethereum Service - RPC POST Route", () => {
  ...
  it("Should return correct result and a successful status code if web3 call does not return an error", async () => {
  ...
  it("Should return ping error and status code 400 if web3 call returns an error", async () => {
    const res = await request(app).post(endpoint).send({ url: "test_url.com" });
    expect(res.statusCode).toEqual(400);
    expect(res.body).toEqual({ result: PingStatus.ERROR });
  });

  it("Should return ping timeout and status code 408 if web3 call times out", async () => {
...
describe("Send Test Alert Channels Opsgenie POST Route", () => {
  ...
  it("Should return correct result and a successful status code if opsgenie does not return an error", async () => {
    const res = await request(app)
      .post(endpoint)
  ...
  it("Should return ping error and status code 400 if opsgenie returns an error", async () => {
...
describe("Send Test Alert Channels PagerDuty POST Route", () => {
  ...
  it("Should return correct result and a successful status code if pagerduty does not return an error", async () => {
    // @ts-ignore
    jest.spyOn(pagerDutyApi, "event").mockResolvedValue("result");
    const res = await request(app)
      .post(endpoint)
      .send({ integrationKey: "test" });
    expect(res.statusCode).toEqual(200);
    expect(res.body).toEqual({
      result: PingStatus.SUCCESS,
    });
  ...
  it("Should return error and %s status code if %s", async () => {
    const res = await request(app).post(endpoint).send({});
    expect(res.statusCode).toEqual(532);
    expect(res.body).toEqual({
      error: "Error: Missing key(s) integrationKey in body.",
    });
  });

  it("Should return ping error and status code 400 if pagerduty returns an error", async () => {
...
describe("Send Test Alert Channels Slack POST Route", () => {
  ...
  it("Should return correct result and a successful status code if slack does not raise an error", async () => {
    const res = await request(app)
      .post(endpoint)
  ...
  it("Should return ping error and status code 400 if slack raises an error", async () => {
...
describe("Send Test Alert Channels Telegram POST Route", () => {
  ...
  it("Should return correct result and a successful status code if telegram does not return an error", async () => {
    axiosMock.get.mockResolvedValue(emptyAxiosResponse());
    const res = await request(app)
      .post(endpoint)
      .send({ botToken: "test", botChatId: "test" });
    expect(res.statusCode).toEqual(200);
    expect(res.body).toEqual({ result: PingStatus.SUCCESS });
  });
  ...
  it.each([
    ...
    [
      532,
      "botChatId not specified",
      { botToken: "test" },
      { error: "Error: Missing key(s) botChatId in body." },
    ],
    [
      532,
      "botToken and botChatId not specified",
      {},
  ...
  it("Should return ping error and status code 408 if telegram returns a time out error", async () => {
    axiosMock.get.mockRejectedValue({ code: "ECONNABORTED" });
    const res = await request(app)
      .post(endpoint)
      .send({ botToken: "test", botChatId: "test" });
  ...
  it("Should return ping error and status code 400 if telegram returns an error", async () => {
    axiosMock.get.mockRejectedValue({ code: "RANDOMERROR" });
    const res = await request(app)
      .post(endpoint)
      .send({ botToken: "test", botChatId: "test" });
...
describe("Send Test Alert Channels Twilio POST Route", () => {
  ...
  it("Should return correct result and a successful status code if twilio does not return an error", async () => {
    twilioClientCallsCreateResolve = { test: "test" };
    const res = await request(app).post(endpoint).send({
      accountSid: "test",
      authToken: "test",
      twilioPhoneNumber: "test",
      phoneNumberToDial: "test",
    });
    expect(res.statusCode).toEqual(200);
    expect(res.body).toEqual({ result: PingStatus.SUCCESS });
  });
  ...
  it.each([
    ...
    [
      532,
      "twilioPhoneNumber not specified",
      { accountSid: "test", authToken: "test", phoneNumberToDial: "test" },
      { error: "Error: Missing key(s) twilioPhoneNumber in body." },
    ],
    [
      532,
      "phoneNumberToDial not specified",
      { accountSid: "test", authToken: "test", twilioPhoneNumber: "test" },
      { error: "Error: Missing key(s) phoneNumberToDial in body." },
    ],
    [
      532,
      "accountSid and authToken not specified",
      { twilioPhoneNumber: "test", phoneNumberToDial: "test" },
      { error: "Error: Missing key(s) accountSid, authToken in body." },
    ],
    [
      532,
      "twilioPhoneNumber and phoneNumberToDial not specified",
      { accountSid: "test", authToken: "test" },
      {
        error:
          "Error: Missing key(s) twilioPhoneNumber, phoneNumberToDial in body.",
      },
    ],
    [
      532,
      "accountSid, authToken, twilioPhoneNumber, and phoneNumberToDial not specified",
      {},
      {
        error:
          "Error: Missing key(s) accountSid, authToken, twilioPhoneNumber, phoneNumberToDial in body.",
      },
    ],
  ])(
    "Should return error and %s status code if %s",
  ...
  it("Should return ping error and status code 400 if twilio returns an error", async () => {
    const res = await request(app).post(endpoint).send({
      accountSid: "test",
      authToken: "test",
      twilioPhoneNumber: "test",
...
describe("Send Test Alert Channels Email POST Route", () => {
  ...
  it("Should return correct result and a successful status code if email does not return an error", async () => {
    const res = await request(app).post(endpoint).send({
      smtp: "test",
      port: 123,
      from: "test",
  ...
  it.each([
    ...
    [
      532,
      "smtp, port, from, to, username, and password not specified",
      {},
      {
        error:
          "Error: Missing key(s) smtp, port, from, to, username, password in body.",
      },
    ],
  ])(
    "Should return error and %s status code if %s",
  ...
  it("Should return ping error and status code 400 if email client returns an error", async () => {
  ...
  it("Should return ping error and status code 400 if sending email returns an error", async () => {
...
describe("Server Defaults", () => {
  it.each([["/server/"], ["/server/bad-endpoint"]])(
