...
import {
  BaseChainModel,
  BaseChainSchema,
} from "../../../src/v1/entity/model/BaseChainModel";
import { ConfigModel } from "../../../src/v1/entity/model/ConfigModel";
import {
  GenericModel,
  GenericSchema,
} from "../../../src/v1/entity/model/GenericModel";
import {
...
export class GenericErrorMockService {
  public static mockFind(): void {
    mockingoose(GenericModel).toReturn(
      new Error("Error to find a document!"),
      "find"
    );
    mockingoose(SeverityAlertSubconfigModel).toReturn(
      new Error("Error to find a document!"),
      "find"
    );
  }
