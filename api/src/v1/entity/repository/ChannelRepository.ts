...
class ChannelRepository<T extends Channel> extends AbstractRepository<T> {
   ...
   */
  public async findAllByAndDeepPopulate(
   ...
   */
  public async findOneByAndDeepPopulate(
    id: string,
    fieldsToPopulate: string[],
    config_type_id: string,
    populateObject
   ...
   */
  public async linkConfigToChannel(
    channel_id: string,
    config_id: string
    ...
    return this.model.updateOne(
      {
        _id: channel_id,
        config_type: {
          $ne: new ObjectId(GenericDocument.CONFIG_TYPE_SUB_CHAIN),
        },
      },
      // @ts-ignore
   ...
   * @returns update result
   */
  public async unlinkConfigFromChannel(
    channel_id: string,
    config_id: string
  ): Promise<UpdateWriteOpResult> {
    return this.model.updateOne(
   ...
   * @returns update result
   */
  public async unlinkConfigFromAllChannels(
    config_id: string
  ): Promise<UpdateWriteOpResult> {
  ...
  public async isDuplicateChannelName(channel: Channel): Promise<Boolean> {
    if ("name" in channel) {
      ...
      const isValidConfigID =
        "id" in channel && mongoose.Types.ObjectId.isValid(channel.id);
...
export class EmailRepository extends ChannelRepository<EmailChannel> {
  ...
  public async findAllByAndDeepPopulate(
    fieldsToPopulate: string[],
    populateObject
  ): Promise<Array<EmailChannel>> {
    return super.findAllByAndDeepPopulate(
      fieldsToPopulate,
      GenericDocument.CONFIG_TYPE_EMAIL_CHANNEL,
      populateObject
    );
  }
...
export class OpsgenieRepository extends ChannelRepository<OpsgenieChannel> {
  ...
  public async findAllByAndDeepPopulate(
    fieldsToPopulate: string[],
    populateObject
  ): Promise<Array<OpsgenieChannel>> {
    return super.findAllByAndDeepPopulate(
      fieldsToPopulate,
      GenericDocument.CONFIG_TYPE_OPSGENIE_CHANNEL,
      populateObject
    );
  }
...
export class PagerDutyRepository extends ChannelRepository<PagerDutyChannel> {
  ...
  public async findAllByAndDeepPopulate(
    fieldsToPopulate: string[],
    populateObject
  ): Promise<Array<PagerDutyChannel>> {
    return super.findAllByAndDeepPopulate(
      fieldsToPopulate,
      GenericDocument.CONFIG_TYPE_PAGERDUTY_CHANNEL,
      populateObject
    );
  }
...
export class SlackRepository extends ChannelRepository<SlackChannel> {
  ...
  public async findAllByAndDeepPopulate(
    ...
    return super.findAllByAndDeepPopulate(
      fieldsToPopulate,
      GenericDocument.CONFIG_TYPE_SLACK_CHANNEL,
      populateObject
    );
  }
...
export class TelegramRepository extends ChannelRepository<TelegramChannel> {
  ...
  public async findAllByAndDeepPopulate(
    fieldsToPopulate: string[],
    populateObject
  ): Promise<Array<TelegramChannel>> {
    return super.findAllByAndDeepPopulate(
      fieldsToPopulate,
      GenericDocument.CONFIG_TYPE_TELEGRAM_CHANNEL,
      populateObject
    );
  }
...
export class TwilioRepository extends ChannelRepository<TwilioChannel> {
  ...
  public async findAllByAndDeepPopulate(
    fieldsToPopulate: string[],
    populateObject
  ): Promise<Array<TwilioChannel>> {
    return super.findAllByAndDeepPopulate(
      fieldsToPopulate,
      GenericDocument.CONFIG_TYPE_TWILIO_CHANNEL,
      populateObject
    );
  }
